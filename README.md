...
version: 0.3(beta), last change: 08/16/2012 20:51 v0.3 新增内容 [自定义配置文件名](/thinkjs/autocommand/wiki/quickref03#wiki-a2_5)、[多路径配置](/thinkjs/autocommand/wiki/quickref03#wiki-a3_2)
